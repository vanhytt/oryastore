...
import { getNews, createNews, updateNews, deleteNews, NewsItem } from "../../lib/dbService";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (editingNews) {
        ...
        onSuccess("Cập nhật bài viết thành công!");
      } else {
        await createNews(payload);
        onSuccess("Thêm bài viết mới thành công!");
      }
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-gray-50 text-gray-600 text-xs font-bold uppercase border-b border-gray-200">
                ...
                <th className="py-3 px-5">Tiêu đề bài viết</th>
            ...
            <tbody className="divide-y divide-gray-100 text-sm">
              {filteredNews.map((news) => (
                <tr key={news.id} className="hover:bg-gray-50/50 transition-colors">
                  ...
                  <td className="py-3 px-5 font-medium text-gray-800 max-w-sm truncate">
                    {news.title}
                  </td>
          ...
          <div className="bg-white rounded-lg shadow-xl border border-gray-200 w-full max-w-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-150">
            ...
            <div className="px-6 py-4 bg-gray-50 border-b border-gray-200 flex items-center justify-between">
              <h3 className="text-gray-800 font-bold text-lg">
                {editingNews ? "Chỉnh sửa bài viết" : "Viết bài viết mới"}
              </h3>
              <button
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    placeholder="VD: Cách bảo vệ da nhạy cảm của bé sơ sinh..."
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      required
                      placeholder="VD: Dược sĩ Minh Thư..."
                      className="w-full px-3 py-2 border border-gray-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-[#5D8D4A]/50 focus:border-[#5D8D4A]"
                    />
                  </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    placeholder="Tóm tắt ngắn gọn nội dung bài viết hiển thị trên trang chủ..."
                    className="w-full px-3 py-2 border border-gray-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-[#5D8D4A]/50 focus:border-[#5D8D4A]"
                  />
                </div>
